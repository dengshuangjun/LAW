...
public class User implements Serializable {
	...
	public String toString() {
		return "User [usid=" + usid + ", usname=" + usname + ", usex=" + usex + ", upwd=" + upwd + ", uemail=" + uemail
				+ ", role_id=" + role_id + ", picpath=" + picpath + ", tel=" + tel + ", law_user_status="
				+ law_user_status + ", law_user_status_explain=" + law_user_status_explain + ", area=" + area
				+ ", register_time=" + register_time + ", birthday=" + birthday + "]";
	}
	...
	public int hashCode() {
		...
		result = prime * result + ((law_user_status == null) ? 0 : law_user_status.hashCode());
		result = prime * result + ((law_user_status_explain == null) ? 0 : law_user_status_explain.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (law_user_status_explain == null) {
			if (other.law_user_status_explain != null)
				return false;
		} else if (!law_user_status_explain.equals(other.law_user_status_explain))
			return false;
		if (picpath == null) {
